...
try {
    ...
    $stmt = $pdo->query("SELECT COUNT(*) FROM users u JOIN roles r ON u.role_id = r.id WHERE r.name = 'donor' AND u.availability_status = 'Available'");
    $available_donors = $stmt->fetchColumn();
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light dashboard-navbar">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="hospital.php">
                <i class="fas fa-tint text-danger"></i>
                <span class="fw-bold">BloodNet Hospital</span>
            </a>
            ...
            <div class="navbar-nav ms-auto">
                ...
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><h6 class="dropdown-header">Hospital Notifications</h6></li>
                ...
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><h6 class="dropdown-header">Hospital Account</h6></li>
    ...
    <div class="dashboard-wrapper">
        ...
        <aside class="dashboard-sidebar" id="dashboardSidebar">
            <ul class="sidebar-menu">
                <li class="sidebar-menu-item">
                    <a href="hospital.php" class="sidebar-menu-link active">
        ...
        <main class="dashboard-main" id="dashboardMain">
            ...
            <div class="announcement-card fade-in-up">
                <h4><i class="fas fa-bed-pulse me-2"></i>Hospital Resources</h4>
                <p><?php echo $available_donors; ?> donors are currently available. Post urgent requests for immediate response.</p>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-12">
                    <div class="profile-card dashboard-card fade-in-up">
                        ...
                        <p class="profile-role">Medical Center</p>
